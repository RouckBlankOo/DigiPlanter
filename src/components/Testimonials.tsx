...
const Testimonials: React.FC = () => {
  const testimonials = [
    {
      quote:
        "This app has transformed how I care for my houseplants. The notifications are so helpful, and my plants have never looked healthier!",
      author: "Sarah Ammar",
      role: "Plant Enthusiast",
    },
    {
      quote:
        "As someone who always forgot to water my plants, this app has been a lifesaver. I love the detailed care instructions for each plant species.",
      author: "Ahmed souguir",
      role: "Busy Professional",
    },
    {
      quote:
        "The analytics feature helps me understand exactly what my rare plants need. This is a must-have for any serious collector.",
      author: "Emna Chouchen",
      ...
      <div className="container mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-foreground/70 max-w-2xl mx-auto">
            Join thousands of happy plant owners who have transformed their
